...
to_dir = "C:/Users/ritia/OneDrive/Desktop/random"
...
for file_name in list_of_files:
    ...
    if extension in ['.txt', '.pdf', '.doc', '.docx']:
        ...
        path2 = to_dir + '/' + "text_Files"                     # Example path2 : D:/My Files/Image_Files      
        path3 = to_dir + '/' + "text_Files" + '/' + file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
